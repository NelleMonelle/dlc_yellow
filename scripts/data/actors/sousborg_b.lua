local actor, super = Class(Actor, "sousborg_b")
...
function actor:init()
    ...
    self:addLightBattlerPart("body", {
        ["create_sprite"] = function()
            local sprite = Sprite(self.path.."/body", 73, 131)
    ...
    self:addLightBattlerPart("head", {
        ["create_sprite"] = function()
            local sprite = Sprite(self.path.."/head", 72.5, 72)
            sprite:setOrigin(0.5, 1)
            sprite.layer = 410
            return sprite
        end
    ...
    self:addLightBattlerPart("right_arm_1", {
        ["create_sprite"] = function()
            local sprite = Sprite(self.path.."/right_arm_1", 113, 102)
            sprite:setOrigin(0.5, 1)
            sprite.layer = 390
            return sprite
        end
    ...
    self:addLightBattlerPart("right_arm_2", {
        ["create_sprite"] = function()
            local sprite = Sprite(self.path.."/right_arm_2", 125.5, 94)
            sprite:setOrigin(0.5, 1)
            sprite.layer = 400
            return sprite
        end
    ...
    self:addLightBattlerPart("right_hand", {
        ["create_sprite"] = function()
            local sprite = Sprite(self.path.."/right_hand", 125, 67)
            sprite:setOrigin(0.5, 1)
            sprite.layer = 410
            sprite:play(1/8)
            return sprite
    ...
    self:addLightBattlerPart("left_arm_1", {
        ["create_sprite"] = function()
            local sprite = Sprite(self.path.."/left_arm_1", 33, 97)
            sprite:setOrigin(0.5, 1)
            sprite.layer = 390
            return sprite
        end
    ...
    self:addLightBattlerPart("left_arm_2", {
        ["create_sprite"] = function()
            local sprite = Sprite(self.path.."/left_arm_2", 21, 95)
            sprite:setOrigin(0.5, 1)
            sprite.layer = 400
            return sprite
        end
    ...
    self:addLightBattlerPart("left_hand", {
        ["create_sprite"] = function()
            local sprite = Sprite(self.path.."/left_hand", 15, 79)
            sprite:setOrigin(0.5, 1)
            sprite.layer = 410
            return sprite
        end
