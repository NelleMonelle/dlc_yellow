local actor, super = Class(Actor, "frostermit_b_revealed")
...
function actor:init()
    ...
    self:addLightBattlerPart("body", {
        ["create_sprite"] = function()
            local sprite = Sprite(self.path.."/body_crab", 4, 0)
    ...
    self:addLightBattlerPart("head", {
        ["create_sprite"] = function()
            local sprite = Sprite(self.path.."/head", 5, 19)
            sprite:setOrigin(0, 0)
            sprite.layer = 410
            return sprite
        end
    ...
    self:addLightBattlerPart("claw_right", {
        ["create_sprite"] = function()
            local sprite = Sprite(self.path.."/claw_right", 35, 23)
            sprite:setOrigin(0, 0)
            sprite.layer = 430
            return sprite
        end
    ...
    self:addLightBattlerPart("leg_right_3", {
        ["create_sprite"] = function()
            local sprite = Sprite(self.path.."/leg_right_3", 53, 18)
            sprite:setOrigin(0, 0)
            sprite.layer = 410
            return sprite
        end
